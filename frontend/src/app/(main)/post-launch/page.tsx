...
export default function PostLaunchPage() {
  ...
  const comparativeGap = useMemo(() => {
    return analytics.comparativeAnalysis.topperBaselineScore - analytics.comparativeAnalysis.currentUserScore;
  }, [analytics]);

  return (
    <main className="space-y-6 p-4 md:p-6">
      <section>
        <h1 className="text-2xl font-semibold">Post-Launch Lab (V1.1 → V1.5)</h1>
        <p className="text-sm text-muted-foreground">First implementation slice for community, advanced AI, content expansion, mobile, and analytics.</p>
      </section>
      ...
      <section className="rounded-lg border border-border bg-card p-4">
          <h2 className="text-lg font-semibold">V1.1 — Community Features</h2>
      ...
      <section className="rounded-lg border border-border bg-card p-4">
          <h2 className="text-lg font-semibold">V1.2 — Advanced AI</h2>
      ...
      <section className="rounded-lg border border-border bg-card p-4">
          <h2 className="text-lg font-semibold">V1.3 — Content Expansion</h2>
      ...
      <section className="rounded-lg border border-border bg-card p-4">
          <h2 className="text-lg font-semibold">V1.4 — Mobile App</h2>
          <p className="mt-2 text-sm">Platform: {mobile.platform}</p>
          <p className="text-sm text-muted-foreground">
            Offline cache: {mobile.offlineMode.cachedAssets.join(', ')} · Max {mobile.offlineMode.maxOfflineDays} days
          </p>
          <p className="text-sm text-muted-foreground">Push: {mobile.pushNotifications.join(', ')}</p>
      </section>

      <section className="rounded-lg border border-border bg-card p-4">
          <h2 className="text-lg font-semibold">V1.5 — Advanced Analytics</h2>
          <p className="mt-2 text-sm">
            Comparative gap vs topper baseline: <span className="font-medium">{comparativeGap} points</span>
          </p>
          <p className="text-sm text-muted-foreground">
            Predicted syllabus completion: {analytics.syllabusFlowPredictedCompletionDate}
          </p>
